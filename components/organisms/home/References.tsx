...
export const References = () => {
  ...
  return (
    <>
      <Button onClick={() => setShowReferences(!showReferences)} text={showReferences ? 'Ver Menos' : 'Ver Mas'} className={styles["references__btn"]} />

      {
        showReferences ?  <div className={styles["references"]}>
          <Swiper
